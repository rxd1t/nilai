                            ...
                            while ($r = mysqli_fetch_assoc($result)) {
                                echo '<tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="?m=kelas&s=delete&id='.$r['id'].'" class="btn btn-danger btn-sm" onclick="return confirm(\'Yakin Kelas akan dihapus?, Hapus 1 Kelas akan menghapus semua data kelas di Kelas tersebut\')">Hapus</a>
                                    </td>
                                </tr>';
                                $no++;
                            }
